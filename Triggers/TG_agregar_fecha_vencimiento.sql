...
CREATE OR REPLACE FUNCTION SP_agregar_fecha_vencimiento()
    ...
    $$
        ...
        BEGIN
				...
				va_ultimo_dia_fecha:=  (date_trunc('month', va_fecha) + interval '1 month') - interval '1 day';
				...
				new.fechavencimiento := DATE( cast (va_fecha_vencimiento as varchar) || '-' || cast((va_fecha + interval '1 MONTH') as varchar ));
